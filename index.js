...
const runBudget = (startingMoney, startOfMonth, pay, expenses) => {
  ...
  for (let i = 0; i < date.daysInMonth(); i++) {
    const today = moment(beginningOfMonth).add(i, 'days');
...
const month = runBudget(2200, '2019-08-01', pay, expenses);
console.log(month)

module.exports.default = runBudget;
